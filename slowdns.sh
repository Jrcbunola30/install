...
dnsdomain=privatessh.tech
dnszone=fdd2f1692bcf6c068f569652b26c3252
...
#install slowdns
curl -X POST "https://api.cloudflare.com/client/v4/zones/$dnszone/dns_records" -H "X-Auth-Email: bunolajrc1989@gmail.com" -H "X-Auth-Key: a3c350a367192bad8e0e90d456aad9d732afd" -H "Content-Type: application/json" --data '{"type":"NS","name":"'"$(echo $nsrecord)"'","content":"'"$(echo $arecord)"'","ttl":1,"priority":0,"proxied":false}' &>/dev/null
